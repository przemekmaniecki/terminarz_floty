...
from Pojazdy.choice import *


# Create your models here.
def VIN_walidator(value):
    if len(value) != 17:
...
class PojazdyModel(models.Model):
    ...
    VIN = models.CharField(max_length=17,  unique=True, validators=[VIN_walidator, VIN_unique])
    nr_rej = models.CharField(max_length=8, unique=True, verbose_name='nr rej.', validators=[REJ_walidator, REJ_unique])
...
class BT(models.Model):
    ...
    pojazd = models.OneToOneField(PojazdyModel, on_delete=models.CASCADE, primary_key=True, related_name='przegladtech')
    def __str__(self):
...
class tacho(models.Model):
    ...
    pojazd = models.OneToOneField(PojazdyModel, on_delete=models.CASCADE, related_name='przegladtacho')
    def __str__(self):
        return self.pojazd.nr_rej
...
class ADR(models.Model):
    ...
    wymagane = models.BooleanField(default=False)
    data_konc = models.DateField(blank=True, null=True)
    pojazd = models.OneToOneField(PojazdyModel, on_delete=models.CASCADE, primary_key=True, related_name='przegladadr')
    def __str__(self):
        return self.pojazd.nr_rej
...
class NormaCzystosciSpalin(models.Model):
    ...
    wymagane = models.BooleanField(default=False)
    pojazd = models.OneToOneField(PojazdyModel, on_delete=models.CASCADE, primary_key=True , related_name='normaeuro')
...
class FRC(models.Model):
    ...
    wymagane = models.BooleanField(default=False)
    data_konc = models.DateField(blank=True, null=True)
    pojazd = models.OneToOneField(PojazdyModel, on_delete=models.CASCADE, primary_key=True, related_name='przegladfrc')
    def __str__(self):
        return self.pojazd.nr_rej
...
class UDT(models.Model):
    ...
    wymagane = models.BooleanField(default=False)
    data_konc = models.DateField(blank=True, null=True)
    pojazd = models.OneToOneField(PojazdyModel, on_delete=models.CASCADE, primary_key=True, related_name='przegladudt')
    def __str__(self):
        return self.pojazd.nr_rej
...
class TDT(models.Model):
    ...
    wymagane = models.BooleanField(default=False)
    data_konc = models.DateField(blank=True, null=True)
    pojazd = models.OneToOneField(PojazdyModel, on_delete=models.CASCADE, primary_key=True, related_name='przegladtdt')
    def __str__(self):
        return self.pojazd.nr_rej
class UKO(models.Model):
    ...
    pojazd = models.OneToOneField(PojazdyModel, on_delete=models.CASCADE, primary_key=True, related_name='komunikacyjne')
